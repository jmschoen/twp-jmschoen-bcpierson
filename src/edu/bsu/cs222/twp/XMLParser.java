...
public class XMLParser {
	...
	public static String getRedirectAndTitle(String xmlFileData){
		...
		String pageTitle = xmlFileData.substring(firstIndexOfTitle, endIndexOfTitle);
		if (xmlFileData.contains("<normalized><n from=\"")){
			int firstIndexOfRedirect = xmlFileData.indexOf("<normalized><n from=\"") + 21;
			int endIndexOfRedirect = xmlFileData.indexOf("\"", firstIndexOfRedirect);
			String pageRedirect = xmlFileData.substring(firstIndexOfRedirect, endIndexOfRedirect);
