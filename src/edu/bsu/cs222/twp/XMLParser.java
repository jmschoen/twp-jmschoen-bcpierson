...
public class XMLParser {
	...
	public ArrayList<String> trimStrings(String[] s){
	...
	public ArrayList<Revision> createRevisions(ArrayList<String> revisionData){
