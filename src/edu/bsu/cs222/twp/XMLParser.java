...
public class XMLParser {
	...
	public static ArrayList<Revision> parseXML(String s){
		String[] strings = splitString(s);
		ArrayList<String> revisionData = trimStrings(strings);
		return createRevisions(revisionData);
	}
	...
	public static ArrayList<Revision> createRevisions(ArrayList<String> revisionData){
